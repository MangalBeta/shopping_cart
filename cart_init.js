...
// //var db = mongoose.connect('mongodb://localhost/Shopping_Cart');
...
//  var ProductQuantity = require("./models/ProductQuentity");
...
//   addProduct(customer, order, 'Delicate Arch Print','/images/arch.png', 12.34,'View of the breathtaking Delicate Arch in Utah', Math.floor((Math.random()*10)+1));
...
// //      'pyramid.jpg', 38.52,'Look at the amazing architecture of early America.', Math.floor((Math.random()*10)+1));     

// //    addProduct(customer, order,
// //     'Glacial Lake Print',
// //      'lake.jpg', 77.45,
// //     'Vivid color, crystal clear water from glacial runoff.', Math.floor((Math.random()*10)+1));
// });
//               });
//                  //});  
//                   // });
